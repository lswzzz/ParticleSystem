...
void C3DParticleSystem::reset(int v_TotalSize, eParticleType _type, BlendFunc func)
{
...
void C3DParticleSystem::resetParticleAccelerationMin(Vec3 acc)
{
	m_sParticleData.m_Acceleration_Min = acc;
}

void C3DParticleSystem::resetParticleAccelerationMax(Vec3 acc)
{
	m_sParticleData.m_Acceleration_Max = acc;
}

void C3DParticleSystem::resetParticleSizeMin(Vec3 size)
{
	m_sParticleData.m_Size_Min = size;
}

void C3DParticleSystem::resetParticleSizeMax(Vec3 size)
{
	m_sParticleData.m_Size_Max = size;
}

void C3DParticleSystem::resetParticleSizeVelocity(Vec3 size)
{
	m_sParticleData.m_Size_Velocity = size;
}

void C3DParticleSystem::resetParticleVelocityMin(Vec3 vel)
{
	m_sParticleData.m_Velocity_Min = vel;
}

void C3DParticleSystem::resetParticleVelocityMax(Vec3 vel)
{
	m_sParticleData.m_Velocity_Max = vel;
}

void C3DParticleSystem::resetParticleColorMin(Vec3 color)
{
	m_sParticleData.m_Color_Min = color;
}

void C3DParticleSystem::resetParticleColorMax(Vec3 color)
{
	m_sParticleData.m_Color_Max = color;
}

void C3DParticleSystem::resetParticleColorVelocity(Vec3 col_vel)
{
	m_sParticleData.m_Color_Velocity = col_vel;
}

void C3DParticleSystem::resetParticleLifeMin(float life)
{
	m_sParticleData.m_Life_Min = life;
}

void C3DParticleSystem::resetParticleLifeMax(float life)
{
	m_sParticleData.m_Life_Max = life;
}

void C3DParticleSystem::resetParticleLife_Velocity(float life_v)
{
	m_sParticleData.m_Life_Velocity = life_v;
}

void C3DParticleSystem::setParticleType(eParticleType _type)
{
	m_eParticleType = _type;
