...
#include "../../../Classes/QT/ControlView/ControlView.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ControlView_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ControlView_t qt_meta_stringdata_ControlView = {
    {
QT_MOC_LITERAL(0, 0, 11), // "ControlView"
QT_MOC_LITERAL(1, 12, 24), // "particleTypeIndexChanged"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 5) // "index"

    },
    "ControlView\0particleTypeIndexChanged\0"
    "\0index"
};
...
void ControlView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->particleTypeIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject ControlView::staticMetaObject = {
    { &BaseDockWidget::staticMetaObject, qt_meta_stringdata_ControlView.data,
